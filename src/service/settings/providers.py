"""Modulo para tener un servicio de los datos de los proveedores configurados."""
...
def get(*, orientjson: JsonFrameOrient = None):
    ...
    return PROVIDERS, True, orientjson
...
def save(*,
    ...
    PROVIDERS.save(support, mode, **kwargs)
    return 0, "se ha guardado la informacion configuracion de proveedores"

service = services.service("providers", get, save)
